...
import org.sonar.samples.java.checks.AvoidStarImportRule;
...
import org.sonar.samples.java.checks.StaticVariableReferenceRule;
...
public final class RulesList {
  ...
  public static List<Class<? extends JavaCheck>> getJavaChecks() {
    return Collections.unmodifiableList(Arrays.asList(
      ...
      AvoidStarImportRule.class,
      StaticVariableReferenceRule.class));
  }
